...
public class LibroCalificaciones {
    ...
    private int[][] calificaciones;// arreglo bideimensional de calificaciones de estudiantes
    ...
    public void procesarCalificaciones() {
        ...
        System.out.printf("%n%s %d%n%s %d%n%n",
                ...
                obtenerMinima(),
                "La calificacion más alta en el libro de califcaciones es",
                obtenerMaxima());
    ...
    public int obtenerMinima() {
        ...
        //itera a tracés de las filas del arreglo calificaciones

        for (int[] califEstudiantes : calificaciones) {
            //itera a través de las collumnas de la fila actual
            for (int calificacion : califEstudiantes) {
                // si la calificacion es menor que califBaja, la asinga a califBaja
    ...
    public int obtenerMaxima() {
        ...
        //itera a través de las filas del arreglo calificaicones
    ...
    // determina la calificación promedio para un conunto especifico de calificaciones

    public double obtenerPromedio(int[] conjuntoDeCalif) {
        int total = 0;


        //suma las calificaciones para un estudinate

        for (int calificacion : conjuntoDeCalif)
            total += calificacion;

        //devuleve el promedio de calificaciones
        return (double) total / conjuntoDeCalif.length;
    }

    //imprime gráfico de barras que muestra las distribución de calificaciones en general.
    ...
    public void imprimirGraficoBarras() {
        ...
        //para cada calificación en LibroCalificaciones, inccrementa la frecuenci apropiada
        ...
        // para cada frecuencia de calificacones, imprime una barra en el gráfico
    ...
    public void imprimirCalificaciones(){
        ...
        //crea un encabezado de columa para cada una de las pruebas
        ...
        for(int estudiante=0; estudiante< calificaciones.length; estudiante++  )
        {
            ...
            for(int prueba: calificaciones[estudiante])  // imprime calificaciones de estudiantes
